...
local L_8_ = L_7_:NewSection("Phasee")
L_8_:NewButton(
    "Silent Aim",
...
local L_12_ = L_11_:NewSection("Phasee")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
	...
	L_133_.InputBegan:connect(
		...
		if L_147_arg0.KeyCode == Enum.KeyCode.O then
			L_136_ = not L_136_
			if L_136_ == true then
				repeat
...
local L_14_ = L_13_:NewSection("Phasee")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
local L_19_ = L_17_:NewSection("Phasee")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
